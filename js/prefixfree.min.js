...
e.fixers [f] (a, b, d) || a; return a}, camelCase: function (a) {return a.replace (/ - ([az]) / g, function (b, a) { devolver a.toUpperCase ()}). replace ("-", "")}, deCamelCase: function (a) {return a.replace (/ [AZ] / g, function (b) {return "-" + b .toLowerCase ()})}}; (function () {setTimeout (function () {m ('link [rel = "stylesheet"]'). forEach (StyleFix.link)}, 10); document.addEventListener (" DOMContentLoaded ", StyleFix.process,! 1)}) ()}}) ();
(función (m) {función e (b, d, f, h, k) {b = a [b]; b.length && (b = RegExp (d + "(" + b.join ("|") + " ) "+ f," gi "), k = k.replace (b, h)); return k} if (window.StyleFix && window.getComputedStyle) {var a = window.PrefixFree = {prefixCSS: function (b, d, f) {var h = a. prefijo; -1 <a.functions.indexOf ("gradiente lineal") && (b = b.replace (/ (\ s |: |,) (repitiendo -)? gradiente lineal \ (\ s * (-? \ d * \.? \ d *) deg / ig, función (b, a, d, f) {devolver a + (d || "") + "gradiente lineal (" + (90-f) + "deg"})); b = e ("funciones", "(\\ s |: |,)", "\\ s * \\ (", "$ 1" + h + "$ 2 (", b); b = e (" palabras clave "," (\\ s | :) "," (\\ s |; | \\} | $) ",
...
d ["repeat-linear-gradient"] = d ["repeating-radial-gradient"] = d ["radial-gradient"] = d ["linear-gradient"]; var f = {initial: "color", agarrar: "cursor", agarrar: "cursor", "zoom-in": "cursor", "alejar": "cursor", cuadro: "pantalla", flexbox: "pantalla", "inline-flexbox": "display", flex: "display", "inline-flex": "display", grid: "display", "inline-grid": "display", "max-content": "width", "min-content ":" width "," fit-content ":" width "," fill-available ":" width "," contener-floats ":" width "}; a.functions = []; a.keywords = [] ; var e = document.createElement ("div"). style,
